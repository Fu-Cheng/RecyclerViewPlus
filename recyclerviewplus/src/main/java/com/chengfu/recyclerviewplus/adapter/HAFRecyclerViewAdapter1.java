 ...
 */
public class HAFRecyclerViewAdapter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private HAFRecyclerViewAdapter1() {
    }
     ...
     * @param innerAdapter
     */
    public HAFRecyclerViewAdapter1(RecyclerView.Adapter innerAdapter) {
    ...
    private class HeaderAndFooterSpanSizeLookup extends GridLayoutManager.SpanSizeLookup {
        ...
        private HAFRecyclerViewAdapter1 adapter;
        private GridLayoutManager gridLayoutManager;
        private GridLayoutManager.SpanSizeLookup userSpanSizeLookup;

        public HeaderAndFooterSpanSizeLookup(HAFRecyclerViewAdapter1 adapter, GridLayoutManager gridLayoutManager, GridLayoutManager.SpanSizeLookup userSpanSizeLookup) {
